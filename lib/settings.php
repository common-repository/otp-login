        ...
        <div class="otpl-setting">
			...
			<div class="first otpl-tab" id="div-otpl-general">
				...
				<td style="vertical-align:top;"><table>
					...
					<tr valign="top">
						<th><label for="otpl_register_url">Register Page URL</label><input type="text" value="<?php echo get_option('otpl_register_url'); ?>" name="otpl_register_url" id="otpl_register_url"  size="40"/><em>define register url for non registerd user</em></th>
					</tr>
